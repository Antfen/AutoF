...
<body id="add_edit_body" style="background: none !important;">
	...
	<div id="main_content" class="container_12">
		...
		<div class="width-container" style="width:100% !important;">
			...
			<form name="f" method='post' id='form_new_store' enctype="multipart/form-data" onSubmit="getCategories(); return false;">
				<fieldset>
