	...
	<div class="rs-dashboard">
		...
		<div class="rs-dash-widget">
			<?php
				...
				// next line changed by paul 
				$can_connect = true;//get_option('revslider-connection', false);
		...
		// start added by paul 
		$dashboard_required_array = apply_filters('revslider_dashboard_elements', $dashboard_required_array, $dbvariables);
		// end added by paul 
