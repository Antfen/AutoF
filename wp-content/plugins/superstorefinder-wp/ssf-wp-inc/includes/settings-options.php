...
$ssf_wp_mdo[] = array("field_name" => "notification_bar", "default" => "false", "input_zone" => "defaults", "label" => __("Notification bar", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='notification_bar'>\n$notification_setting</select>");
...
$ssf_wp_mdo[] = array("field_name" => "search_label", "default" => "Search for nearby stores", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Search bar caption", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='search_label' value=\"$ssf_wp_vars[search_label]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "outlet_label", "default" => "outlets", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("outlets", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='outlet_label' value=\"$ssf_wp_vars[outlet_label]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "of_label", "default" => "of", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("of", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='of_label' value=\"$ssf_wp_vars[of_label]\" size='14'>");


$ssf_wp_mdo[] = array("field_name" => "clear_all_label", "default" => "Clear All", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Clear All", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='clear_all_label' value=\"$ssf_wp_vars[clear_all_label]\" size='14'>");
...
$ssf_wp_mdo[] = array("field_name" => "stores_near_you", "default" => "Stores near you", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Stores near you", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='stores_near_you' value=\"$ssf_wp_vars[stores_near_you]\" size='14'>");




$ssf_wp_mdo[] = array("field_name" => "by_region_label", "default" => "By Region", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("By Region", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='by_region_label' value=\"$ssf_wp_vars[by_region_label]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "by_category", "default" => "Category", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Category", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='by_category' value=\"$ssf_wp_vars[by_category]\" size='14'>");
$ssf_wp_mdo[] = array("field_name" => "all_category", "default" => "All Category", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("All Category", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='all_category' value=\"$ssf_wp_vars[all_category]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "select_label", "default" => "Select", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Select", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='select_label' value=\"$ssf_wp_vars[select_label]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "cancel_label", "default" => "Cancel", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Cancel", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='cancel_label' value=\"$ssf_wp_vars[cancel_label]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "filter_label", "default" => "Filters", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Filter", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='filter_label' value=\"$ssf_wp_vars[filter_label]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "short_search_label", "default" => "Search", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Search", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='short_search_label' value=\"$ssf_wp_vars[short_search_label]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "ssf_next_label", "default" => "Next", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Next", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_next_label' value=\"$ssf_wp_vars[ssf_next_label]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "ssf_prev_label", "default" => "Prev", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Prev", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_prev_label' value=\"$ssf_wp_vars[ssf_prev_label]\" size='14'>");
...
$ssf_wp_mdo[] = array("field_name" => "hours_label", "default" => "Operating Hours", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Hours", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_wp_hours_label' value=\"".$ssf_wp_vars['hours_label']."\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "phone_label", "default" => "Telephone", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Telephone", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_wp_phone_label' value=\"".$ssf_wp_vars['phone_label']."\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "fax_label", "default" => "Fax", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Fax", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_wp_fax_label' value=\"".$ssf_wp_vars['fax_label']."\" size='14'>");
...
$ssf_wp_mdo[] = array("field_name" => "state_label", "default" => "State", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("State", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_wp_state_label' value=\"".$ssf_wp_vars['state_label']."\" size='14'>");
...
$ssf_wp_mdo[] = array("field_name" => "email_label", "default" => "Email", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js",  "label" => __("Email", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_wp_email_label' value=\"".$ssf_wp_vars['email_label']."\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "direction_label", "default" => "Get Directions", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js",  "label" => __("Get Directions", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='direction_label' value=\"".$ssf_wp_vars['direction_label']."\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "streetview_label", "default" => "Street View", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js",  "label" => __("Street View", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='streetview_label' value=\"".$ssf_wp_vars['streetview_label']."\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "Url_label", "default" => "View More", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("View More", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='Url_label' value=\"$ssf_wp_vars[Url_label]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "ssf_contact_us", "default" => "Contact Us", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Contact Us", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_contact_us' value=\"$ssf_wp_vars[ssf_contact_us]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "ssf_close_btn", "default" => "Close", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Pop-Up Close Label", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_close_btn' value=\"$ssf_wp_vars[ssf_close_btn]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "by_distance_label", "default" => "By Radius", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("By Radius", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='by_distance_label' value=\"$ssf_wp_vars[by_distance_label]\" size='14'>");
...
$ssf_wp_mdo[] = array("field_name" => "contact_us_store", "default" => "Contact Store", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Contact Heading Label", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='contact_us_store' value=\"$ssf_wp_vars[contact_us_store]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "contact_us_name", "default" => "Name", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Contact Name", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='contact_us_name' value=\"$ssf_wp_vars[contact_us_name]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "contact_plc_name", "default" => "Please enter your name", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Name Placeholder", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='contact_plc_name' value=\"$ssf_wp_vars[contact_plc_name]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "contact_us_email", "default" => "Email", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Contact E-mail", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='contact_us_email' value=\"$ssf_wp_vars[contact_us_email]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "contact_plc_email", "default" => "Please enter your email address", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Email Placeholder", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='contact_plc_email' value=\"$ssf_wp_vars[contact_plc_email]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "contact_us_phone", "default" => "Telephone", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Contact Telephone", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='contact_us_phone' value=\"$ssf_wp_vars[contact_us_phone]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "contact_plc_phone", "default" => "Please enter your number", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Telephone Placeholder", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='contact_plc_phone' value=\"$ssf_wp_vars[contact_plc_phone]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "contact_us_msg", "default" => "Message", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Contact Message", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='contact_us_msg' value=\"$ssf_wp_vars[contact_us_msg]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "contact_plc_msg", "default" => "Please enter your Message", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Message Placeholder", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='contact_plc_msg' value=\"$ssf_wp_vars[contact_plc_msg]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "contact_us_btn", "default" => "Send Message", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Submit Button", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='contact_us_btn' value=\"$ssf_wp_vars[contact_us_btn]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "msg_sucess", "default" => "Message sent successfully", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Message sent successfully", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='msg_sucess' value=\"$ssf_wp_vars[msg_sucess]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "msg_fail", "default" => "Message delivery failed", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Message delivery failed", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='msg_fail' value=\"$ssf_wp_vars[msg_fail]\" size='14'>");

/**Ratting and review settings **/
$ssf_wp_mdo[] = array("field_name" => "review_label", "default" => "reviews", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Reviews", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='review_label' value=\"$ssf_wp_vars[review_label]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "review_and_ratings", "default" => "Reviews & Ratings", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Reviews & Ratings", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='review_and_ratings' value=\"$ssf_wp_vars[review_and_ratings]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "ratting_label", "default" => "Rating", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Rating", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ratting_label' value=\"$ssf_wp_vars[ratting_label]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "reviewed_by", "default" => "Reviewed by", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Reviewed by", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='reviewed_by' value=\"$ssf_wp_vars[reviewed_by]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "review_submit_button", "default" => " Submit Your Review", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Reviews Submit button", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='review_submit_button' value=\"$ssf_wp_vars[review_submit_button]\" size='14'>");


$ssf_wp_mdo[] = array("field_name" => "no_ratting_msg", "default" => "No ratings for this product", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("No Rating message", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='no_ratting_msg' value=\"$ssf_wp_vars[no_ratting_msg]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "ratting_submit_msg", "default" => "Your rating has been added successfully", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Rating successfully  message", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ratting_submit_msg' value=\"$ssf_wp_vars[ratting_submit_msg]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "allready_voted_msg", "default" => "You have already voted", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("You have already voted", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='allready_voted_msg' value=\"$ssf_wp_vars[allready_voted_msg]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "login_button_msg", "default" => "Please sign in / sign up to leave rating and review.", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Login button label", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='login_button_msg' value=\"$ssf_wp_vars[login_button_msg]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "rating_comment_label", "default" => "Comments", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Comments Label", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='rating_comment_label' value=\"$ssf_wp_vars[rating_comment_label]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "reCAPTCHA_warning", "default" => "Please enter your reCAPTCHA", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("reCAPTCHA validation message", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='reCAPTCHA_warning' value=\"$ssf_wp_vars[reCAPTCHA_warning]\" size='14'>");

$ssf_wp_mdo[] = array("field_name" => "rating_select_validation", "default" => "Please enter your rating", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Rating validation message", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='rating_select_validation' value=\"$ssf_wp_vars[rating_select_validation]\" size='14'>");
